export const perguntas = [
    {
        enunciado: "A guerra poderia sobre as ias ter sido evitada?",
        alternativas: [
            {
                texto: "Não poderia ser realizada.",
                afirmacao: [
            ...
            },
            {
                texto: "Poderia.",
                afirmacao: [
                    "Sim, através de negociações diplomáticas mais eficazes, acordos de paz poderiam ter sido alcançados antes do início do conflito.",
